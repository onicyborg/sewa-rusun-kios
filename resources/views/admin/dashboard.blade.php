...
@section('content')
    ...
    <h6 class="op-7 mb-2">Informasi Rusun (Bulan Ini)</h6>
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                <p class="card-category">Jumlah Rusun Disewa</p>
                                <h4 class="card-title">{{ $jumlahRusunTerisi }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-icon">
                            <div class="icon-big text-center icon-info bubble-shadow-small">
                                <i class="fas fa-door-open"></i> <!-- Ikon untuk Unit Kosong -->
                            </div>
                        </div>
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                <p class="card-category">Jumlah Rusun Kosong</p>
                                <h4 class="card-title">{{ $jumlahRusunKosong }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-stats card-round">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                <p class="card-category">Pemasukan Rusun</p>
                                <h4 class="card-title">Rp. {{ number_format($totalPembayaranRusunLunas) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-icon">
                            <div class="icon-big text-center icon-secondary bubble-shadow-small">
                                <i class="fas fa-exclamation-circle"></i> <!-- Ikon untuk Tagihan -->
                            </div>
                        </div>
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                <p class="card-category">Tagihan Belum Dibayar</p>
                                <h4 class="card-title">Rp. {{ number_format($totalPembayaranRusunTunggak) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <h6 class="op-7 mb-2">Informasi Kios (Bulan Ini)</h6>
    <div class="row">
        <div class="col-sm-6 col-md-3">
            <div class="card card-stats card-round">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                <p class="card-category">Jumlah Kios Disewa</p>
                                <h4 class="card-title">{{ $jumlahKiosTerisi }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-stats card-round">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                <p class="card-category">Jumlah Kios Kosong</p>
                                <h4 class="card-title">{{ $jumlahKiosKosong }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-stats card-round">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                <p class="card-category">Pemasukan Kios</p>
                                <h4 class="card-title">Rp. {{ number_format($totalPembayaranKiosLunas) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                <p class="card-category">Tagihan Belum Dibayar</p>
                                <h4 class="card-title">Rp. {{ number_format($totalPembayaranKiosTunggak) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row card-tools-still-right">
                        <div class="card-title">Keluhan Masuk</div>
                        <div class="card-tools">
                            <a href="/keluhan-admin" class="btn btn-info btn-sm"><i class="fas fa-rocket"></i>&nbsp; Cek Selengkapnya</a>
                        </div>
                    </div>
                </div>
